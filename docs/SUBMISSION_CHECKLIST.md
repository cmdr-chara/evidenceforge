...
The current executable candidate contains 250 tests. Because this checklist changes repository state, exact-head CI for the commit containing it is deliberately a separate external gate recorded on the submission-readiness PR.
...
- [x] `pnpm test` — 250/250 on the executable candidate.
