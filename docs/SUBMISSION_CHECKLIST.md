...
The current executable candidate contains 254 tests. Because this checklist changes repository state, exact-head CI for the commit containing it is deliberately a separate external gate recorded on the submission-readiness PR.
...
- [x] `pnpm test` — 254/254 on the executable candidate.
