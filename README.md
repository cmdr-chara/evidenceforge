...
|---|---|---|
| Repository verification | frozen install, format, lint, typecheck, 254 tests, evaluation, fixture, build, doctor, diff check | the consolidated candidate passes locally; exact-head publication results are recorded on PR #4 |
